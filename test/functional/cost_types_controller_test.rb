...
class CostTypesControllerTest < ActionController::TestCase
  ...
  test "should create cost_type" do
    assert_difference('CostType.count') do
      post :create, cost_type: { distance: @cost_type.distance, interval: @cost_type.interval, number: @cost_type.number, prize: @cost_type.prize, type: @cost_type.type }
    end
  ...
  test "should update cost_type" do
    put :update, id: @cost_type, cost_type: { distance: @cost_type.distance, interval: @cost_type.interval, number: @cost_type.number, prize: @cost_type.prize, type: @cost_type.type }
    assert_redirected_to cost_type_path(assigns(:cost_type))
  end
